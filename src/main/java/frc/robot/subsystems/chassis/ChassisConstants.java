...
public class ChassisConstants {
    ...
    public static class SwerveModuleConstants {
        ...
        public static final SwerveModuleConstants FRONT_LEFT = new SwerveModuleConstants(29.09, 7, 8, 11);
        public static final SwerveModuleConstants FRONT_RIGHT = new SwerveModuleConstants(302.95, 5, 6, 13);
        public static final SwerveModuleConstants BACK_LEFT = new SwerveModuleConstants(226.93, 1, 2, 10);
        public static final SwerveModuleConstants BACK_RIGHT = new SwerveModuleConstants(109.16, 3, 4, 12);
    }
